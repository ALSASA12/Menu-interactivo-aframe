...
AFRAME.registerComponent('button', {
    schema: {
      label: {default: 'label'},
      width: {default: 0.11},
      //toggleable se pone en True cuando no queremos un boton que se alterne entre presionado o no 
    ...
    stateChanged: function () {
      ...
      //Ajustar profundidad del boton cuando se presiona
    ...
    onPressedStarted: function () {
      ...
      //el.components['collision-handler'].onClick()
      alert('He llegado al click')
      el.emit('click');
